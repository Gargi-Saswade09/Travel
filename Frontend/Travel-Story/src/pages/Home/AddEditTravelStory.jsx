...
import upoladImage from '../../utils/upoladImage.js'
...
function AddEditTravelStory({
  ...
  const addNewTravelStory = async() => {
    try {
      ...
      if(storyImg){
        const imgUploadRes = await upoladImage(storyImg);
  ...
  const handleAddOrUpdateClick = () => {
    console.log("User : ", {title, storyImg, story, visitedLocation, visitedDate});
      ...
      <div>
        <div className='flex-1 flex flex-col gap-2 pt-4'>
          ...
          <input 
            ...
            placeholder='A Day at the Great Tower' 
            value={title}
          ...
          <div className='pt-3'>
            <label className='input-lable'>VISITED LOCATION</label>
